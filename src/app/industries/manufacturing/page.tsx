...
const manufacturingData: IndustryData = {
	...
	description: "Professional GPS tracking devices and monitoring systems for forklifts, material handlers, and industrial vehicles in manufacturing facilities.",
	heroImage: "/assets/homepage/1.png",
	challenges: [
		{
			icon: Clock,
			title: "Equipment Location",
			description: "Tracking multiple forklifts and material handlers across large manufacturing facilities.",
		},
		{
			icon: AlertCircle,
			title: "Vehicle Monitoring",
			description: "Maintaining real-time visibility of industrial vehicle locations and operational status.",
		},
		{
			icon: Settings2,
			title: "Maintenance Scheduling",
			description: "Managing regular maintenance schedules for industrial vehicles and equipment.",
		},
	],
	solutions: [
		{
			...
			description: "Heavy-duty GPS tracking hardware designed for industrial vehicles and equipment.",
		},
		{
			icon: Shield,
			title: "Real-Time Monitoring",
			description: "24/7 vehicle tracking system with instant location updates and status monitoring.",
		},
		{
			icon: BarChart3,
			title: "Digital Maintenance Logs",
			description: "Electronic maintenance tracking system with service reminders and history reports.",
		},
	],
	stats: [
		{
	...
	testimonial: {
		quote: "The GPS tracking devices have transformed how we manage our industrial vehicles. We can now track every forklift and material handler in real-time.",
	...
	products: [
		{
			...
			features: ["Rugged GPS hardware", "Real-time location tracking", "Geofencing alerts", "Usage monitoring"],
		},
		{
			title: "Equipment Monitor Pro",
			image: "/assets/homepage/3.png",
			features: ["Vehicle status tracking", "Maintenance scheduling", "Usage reports", "Safety compliance"],
		},
		{
			title: "Factory Fleet Manager",
			image: "/assets/fleet-management/3.png",
			features: ["Multi-vehicle tracking", "Digital maintenance logs", "Performance reports", "Mobile access"],
		},
	],
};
