  ...
  const products: Products[] = [
    {
      ...
      specs: {
        ...
        power: {
          ...
          description: 'Continuous power supply',
        },
        bestFor: {
          icon: Truck,
          value: 'Large Fleets',
        ...
        battery: {
          ...
          description: '48-hour backup power',
        },
        connectivity: {
          icon: Wifi,
          value: '4G LTE + GPS',
    ...
    },
    {
      ...
      specs: {
        installation: {
          icon: Wrench,
          value: 'Plug & Play',
          description: 'Self-installation in minutes',
        },
        power: {
          icon: Zap,
          value: 'OBD-II Port',
          description: 'Vehicle diagnostic port',
        },
        bestFor: {
          icon: Truck,
          value: 'Small-Medium Fleets',
          description: 'Cars & light vehicles',
        },
        battery: {
          icon: Battery,
          value: 'No Battery',
          description: 'Port-powered operation',
        },
        connectivity: {
          icon: Wifi,
          value: '4G LTE',
          description: 'Cellular network only',
        },
        features: {
          icon: Shield,
    ...
    },
    {
      ...
      specs: {
        installation: {
          ...
          description: 'Quick attachment system',
        },
        power: {
          icon: Zap,
          value: 'Battery Powered',
          description: 'Long-life battery pack',
        },
        bestFor: {
          icon: Box,
          value: 'Asset Tracking',
          description: 'Trailers & equipment',
        },
        battery: {
          icon: Battery,
          value: '5-Year Battery',
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-black leading-relaxed">
                  Designed for fleets of all sizes, RidesIQ Tracker offers
                  industry-leading accuracy, real-time tracking, and Real time
                  analytics to enhance fleet efficiency and reduce downtime. Our
                  comprehensive solution helps you make data-driven decisions
                  while ensuring maximum security and reliability.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Know your vehicle's location anytime with GPS updates every 10 seconds.",
                    },
                    {
                      icon: AlertCircle,
                      title: 'Predictive Maintenance',
                      description:
                        'Reduce unexpected breakdowns with Real-Time maintenance predictions.',
                    },
                    {
                      icon: FileText,
                      title: 'Fleet Compliance',
                      description:
                        'Ensure adherence to industry regulations with automated reporting.',
                    },
                    {
                      icon: Activity,
                      title: 'Telematics Data',
                      description:
                        'Gain insights into driver behavior and vehicle performance.',
                    },
                  ].map((benefit, index) => (
                    <motion.div
                      key={benefit.title}
            ...
            {[
              {
                ...
                description:
                  "Monitor your fleet's exact location with live GPS updates every 10 seconds.",
              },
              {
                icon: BarChart3,
                title: 'Real-Time Analytics',
                description:
                  'Gain insights into vehicle performance, driving behavior, and fuel efficiency.',
              },
              {
                icon: Bell,
                title: 'Geofencing & Alerts',
                description:
                  'Set virtual boundaries and receive instant alerts for unauthorized movements.',
              },
              {
                icon: Tool,
                title: 'Predictive Maintenance',
                description:
                  'Prevent costly breakdowns with Real time diagnostics and maintenance scheduling.',
              },
              {
                icon: Lock,
                title: 'Secure Data Encryption',
                description:
                  'End-to-end encrypted tracking to ensure your fleet data remains protected.',
              },
              {
                icon: Radio,
                title: 'Multi-Network Connectivity',
                description:
                  'Reliable tracking with 4G LTE & satellite backup for uninterrupted coverage.',
              },
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
              ...
              <div className="divide-y divide-gray-100">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      'Works with RidesIQ, GeoTab, and other fleet management platforms',
                  },
                  {
                    icon: Shield,
                    name: 'Security',
