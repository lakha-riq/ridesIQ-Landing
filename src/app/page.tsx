	...
	const features = [
		{
			...
			description: "Track every vehicle in your fleet with real-time GPS updates and instant alerts.",
			details: {
				stat: "98%",
				statLabel: "Accuracy Rate",
				image: "/assets/homepage/1.png",
				points: ["Instant GPS vehicle tracking", "Real-time vehicle monitoring", "Predictive maintenance alerts", "Simple reporting for fleet activity"],
			},
		},
		{
			icon: AlertCircle,
			title: "Smart Maintenance",
			description: "Prevent downtime and reduce repair costs with predictive fleet maintenance tools.",
			details: {
				stat: "45%",
				statLabel: "Cost Reduction",
				image: "/assets/homepage/2.png",
				points: ["Predictive maintenance scheduling", "Automated service reminders", "Maintenance history tracking", "Track service history across all vehicles"],
			},
		},
		{
			icon: FileBarChart,
			title: "Advanced Analytics",
			description: "Turn your fleet data into actionable insights to reduce costs and optimize performance.",
			details: {
				stat: "2.5x",
				statLabel: "ROI Increase",
				image: "/assets/homepage/3.png",
				points: ["Custom report generation", "Exportable data for external analysis", "Analyze operational costs across fleet", "Forecast maintenance needs"],
			},
		},
	];
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
							...
							<h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
								<span className="bg-gradient-to-r from-[#678FCA] to-[#99D5C9] bg-clip-text text-transparent">Real-Time GPS Tracking for </span>
							...
							Track every vehicle in real-time, automate toll billing, and recover stolen rentals instantly—powered by RidesIQ’s plug-and-play GPS technology.
							</p>
								...
								<div className="product-render relative z-20 transform hover:scale-105 transition-transform duration-500">
									...
									<div className="absolute -left-4 sm:-left-8 bottom-1/4 bg-white p-4 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
										<div className="flex items-center gap-3">
											...
											<div>
												<div className="text-sm font-medium text-gray-900">Stolen Vehicle Recovery</div>
												<div className="text-xs text-gray-500">Instantly recover lost assets</div>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					>
						...
						>
							...
							<br />
							<span className="bg-gradient-to-r from-[#678FCA] to-[#99D5C9] bg-clip-text text-transparent">Real-Time Telematics</span>
						</motion.h2>
						...
						>
							From real-time vehicle tracking to predictive maintenance and custom analytics—RidesIQ gives you full control over your fleet, anytime, anywhere.
						</motion.p>
					</motion.div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
					...
					>
						...
						>
							...
							<br />
							<span className="bg-gradient-to-r from-[#678FCA] to-[#99D5C9] bg-clip-text text-transparent">Every Vehicle in Your Fleet</span>
						</motion.h2>
						...
						<motion.p
							...
							className="text-xl text-black max-w-2xl mx-auto"
						>
							Avoid downtime, recover assets, and stay in control—no matter your setup.
						</motion.p>
					</motion.div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
						<ProductCard
							...
							image="/assets/homepage/2.png"
							features={["Professionally installed and discreet", "Hidden from drivers for added control", "Notified if removed — pair with SVR", "Continuous power for uninterrupted tracking"]}
							index={0}
						/>
						<ProductCard
							title="OBD Tracker"
							image="/assets/homepage/3.png"
							features={["Plug-and-play via vehicle’s OBD-II port", "Best for company fleets", "Tracks GPS location and diagnostics", "Swap easily between vehicles"]}
							index={1}
						/>
						<ProductCard
							title="Asset Tracker"
							image="/assets/homepage/1.png"
							features={["Long-life, battery-powered design", "Rugged, weather-resistant casing", "Tracks non-powered assets like trailers", "Hidden SVR backup if main tracker is removed"]}
							index={2}
						/>
					</div>
