      ...
      <section className='py-24 relative overflow-hidden bg-gray-50'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative'>
          ...
          >
            <Link
              href='/contact'
              className='bg-[#678FCA] text-white w-[300px] px-8 py-4 rounded-full text-lg font-medium hover:bg-[#678FCA]/90 transition-all duration-300 transform hover:scale-105 flex items-center mx-auto group'
            >
            ...
            <div className='container mx-auto px-4'>
              <div className='grid lg:grid-cols-2 gap-12 lg:gap-16 items-start'>
                ...
                <div className='relative order-1 lg:order-2'>
                  <div
                    className='lg:sticky lg:top-1/2 mt-20 lg:-translate-y-2/4'
                    ref={imageRef}
                  >
                    <motion.div
                      initial={{ opacity: 0, x: 20 }}
