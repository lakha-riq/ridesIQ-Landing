...
export const IndustryTemplate: React.FC<IndustryTemplateProps> = ({ industry, keyFeatures }) => {
	return (
			...
			<section className="py-24 bg-gray-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<motion.div
						...
						className="text-center mb-16"
					>
						<h2 className="text-4xl font-bold mb-4 text-black">Recommended Products</h2>
