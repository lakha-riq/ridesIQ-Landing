...
export const ChallengesSolutions: React.FC<ChallengesSolutionsProps> = ({ challenges, solutions }) => {
	...
	useEffect(() => {
		...
		gsap.set(connectors, { autoAlpha: 0, width: 0 });
					...
					<div className="space-y-6 md:space-y-8">
						{challenges.map((challenge, index) => (
							...
							>
								...
								<div className="hidden md:block absolute top-1/2 -right-12 w-12 h-6 transform -translate-y-1/2 connector overflow-hidden z-0">
								...
								<div className="md:hidden absolute left-1/2 -bottom-6 transform -translate-x-1/2 w-6 h-6 mobile-connector overflow-hidden z-0">
