  ...
  return (
    ...
    >
      ...
      <div className="relative h-full bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 flex flex-col transition-all duration-300 group-hover:shadow-xl">
        ...
        <button className="mt-auto w-full bg-white border-2 border-[#678FCA] text-[#678FCA] px-6 py-3 rounded-full text-sm font-medium hover:bg-[#678FCA] hover:text-white transition-colors flex items-center justify-center group/btn">
          Learn More
