		...
		<div className="container mx-auto p-4">
			<div className="space-y-8">
				<div className=" space-y-4">
					<h2 className="max-w-2xl mx-auto uppercase opacity-50 text-sm tracking-widest">The fleet advantage</h2>
					<h1 className="text-4xl md:text-3xl font-bold max-w-2xl mx-auto">Why Leading Businesses Choose RidesIQ</h1>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto">
					...
					<div className="relative group md:col-span-2 h-[300px] overflow-hidden rounded-3xl bg-gradient-to-b from-[#1E1E1E] via-[#1E325C] to-[#2C4A87]">
						...
						<div className="absolute inset-0 bg-gradient-to-t from-[#1a237e]/80 via-[#1565c0]/60 to-transparent opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
					...
					{/* Automated Card */}
					<div className="relative group h-[300px] overflow-hidden rounded-3xl bg-gradient-to-b from-[#577CA6] via-[#406185] to-[#406185]">
						<div className="p-8 h-full flex flex-col justify-between">
							<div className="flex justify-between items-start">
						...
						<div className="absolute inset-0 bg-gradient-to-t from-[#0d47a1]/80 via-[#1976d2]/60 to-transparent opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
							<div className="absolute bottom-0 left-0 right-0 p-6">
					...
					<div className="relative group h-[300px] overflow-hidden rounded-3xl bg-gradient-to-b from-[#1E1E1E] via-[#22282F] to-[#293243]">
						<div className="p-8 h-full flex flex-col justify-between">
							<div className="flex justify-between items-start">
						...
						<div className="absolute inset-0 bg-gradient-to-t from-[#1a237e]/80 via-[#283593]/60 to-transparent opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
							<div className="absolute bottom-0 left-0 right-0 p-6">
					...
					<div className="relative group md:col-span-2 h-[300px] overflow-hidden rounded-3xl bg-gradient-to-b from-[#2D4A86] via-[#273E74] to-[#1E345E]">
						<div className="p-8 h-full flex flex-col justify-between">
							<div className="flex justify-between items-start">
						...
						<div className="absolute inset-0 bg-gradient-to-t from-[#0d47a1]/80 via-[#1565c0]/60 to-transparent opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
							<div className="absolute bottom-0 left-0 right-0 p-6">
